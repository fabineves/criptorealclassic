...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/criptoreal/criptoreal>";
    const std::string URL_WEBSITE = "<https://criptoreal.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Criptoreal version %s\n", FormatFullVersion());
}
